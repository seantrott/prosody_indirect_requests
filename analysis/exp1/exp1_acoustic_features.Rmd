...
df_audio %>%
  ...
  guides(fill=guide_legend(title="Speaker intent")) +
  theme_minimal()

ggsave("../../Figures/f0_duration_analysis.png", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/f0_duration_analysis.tiff", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/f0_duration_analysis.pdf", 
         units="in", width=6, height=4, dpi=300)
...
ggsave("../../Figures/f0_slope.png", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/f0_slope.tiff", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/f0_slope.pdf", 
         units="in", width=6, height=4, dpi=300)
...
ggsave("../../Figures/mean_intensity.png", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/mean_intensity.tiff", 
         units="in", width=6, height=4, dpi=300)
ggsave("../../Figures/mean_intensity.pdf", 
         units="in", width=6, height=4, dpi=300)
```
...
ggsave("../../Figures/f0_slope_nonconventional_supplementary.pdf", 
         units="in", width=6, height=4, dpi=300)
```
